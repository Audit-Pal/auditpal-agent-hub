    ...
    <div className="flex w-full flex-col gap-4">
      {agents.map((agent) => (
        <article
          ...
          className="group relative cursor-pointer rounded-[26px] border border-[rgba(255,255,255,0.09)] bg-[rgba(9,15,22,0.3)] p-5 backdrop-blur-[16px] transition duration-300 hover:border-[rgba(255,255,255,0.14)] hover:bg-[rgba(12,19,28,0.4)]"
        >
