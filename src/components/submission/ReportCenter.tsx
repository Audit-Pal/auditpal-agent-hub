    ...
    return (
      <section className="rounded-[36px] border border-[#d9d1c4] bg-[#fffdf8] p-8 shadow-[0_20px_60px_rgba(30,24,16,0.08)] md:p-12">
        <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-[#7b7468]">
          {canValidate ? 'Validator queue' : 'Report center'}
        </p>
        <h1 className="mt-4 max-w-3xl font-serif text-5xl leading-none text-[#171717] md:text-6xl">
          {canValidate ? 'No reports are waiting in the human validator queue yet.' : 'Track every finding from the same workspace.'}
        </h1>
        <p className="mt-5 max-w-2xl text-base leading-8 text-[#5f5a51]">
          {canValidate
            ? 'Once bounty hunters submit structured reports and they pass low-effort filtering plus AI triage, they will appear here for accept, reject, or escalate decisions.'
            : 'This view becomes useful as soon as you submit your first report. Every submission now moves through low-effort filtering, AI triage, and organization validation.'}
        </p>
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 font-serif text-5xl leading-none text-[#171717] md:text-6xl">
              {canValidate ? 'AI-triaged reports waiting for a human decision.' : 'Your reports, status changes, and next steps.'}
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-8 text-[#5f5a51]">
              {canValidate
                ? `Review findings that already passed low-effort filtering and AI triage. ${viewerName || 'Your team'} can accept, reject, or escalate each report from this queue.`
                : 'Every submitted report now carries the structured metadata, code context, and status updates needed for the full intake workflow.'}
            </p>
          </div>
            ...
            <div className="mt-4 space-y-3">
              {(canValidate
                ? [
                    ...
                    'Only AI-triaged reports should be accepted, rejected, or escalated here.',
                    'Accepted reports stay persisted with graph context, code evidence, and validator notes.',
                  ]
                : [
                    'Submit a structured report with the graph seed, code context, and replay narrative.',
                    'Low-effort filtering and AI triage run before the report reaches a human validator.',
